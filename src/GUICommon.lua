...
GUICommon.GUI_RESOURCE_TABLE = "cin-res-tables"
GUICommon.GUI_LIMIT_DIALOG = "cin-limit-diag"
GUICommon.GUI_ITEM_PRIORITY = "cin-priority-list"
GUICommon.GUI_REQUESTER_TANK = "cin-requester-tank"
GUICommon.GUI_ENTITY_PANEL = "cin-entity-panel"
